...
export default defineConfig(({ command }) => {
  ...
  return {
    ...
    plugins: [
      ...
      dts(dtsConfig),
      // checker(checkersConfig), // disabled: causes TS5042 "Option 'project' cannot be mixed with source files" during build — see https://docs.twenty.com/developers/self-host/capabilities/troubleshooting
      {
        name: 'copy-theme-css',
        closeBundle() {
